                                        ...
                                        if t_date_key in time_map:
                                            ...
                                            if not shifts:
                                                ...
                                                for i in range(0, len(times), 2):
                                                    t_h = int(times[i].split(':')[0])
                                                    if t_h < 13: shifts.append("早")
                                                    elif 13 <= t_h < 17: 
                                                        shifts.append("午")
                                                        if i+1 < len(times) and int(times[i+1].split(':')[0]) >= 20: shifts.append("晚")
                                                    elif t_h >= 17: shifts.append("晚")
...
<div style="text-align: center; padding: 30px; color: #444444;">
    ...
    <p style="margin: 5px; font-size: 0.9em; color: #666666;">Developed by 林雅婷 | © 2026 Medical Group</p>
</div>
"""
