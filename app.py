...
def check_is_delayed(time_obj, shift_type, clinic_name, date_val=""):
    ...
    if shift_type == "早":
        ...
        if is_licheng:
            ...
            threshold_str = "18:00"
            if not (is_sat and is_special_sat):
                                        ...
                                        if t_date in time_map:
                                            ...
                                            if cell_val and cell_val.lower()!='nan':
                                                ...
                                                if "早" in shifts:
                                                    ...
                                                    shift_times.append(f"{start_t}{selected_conn}{end_t} 早班")
                                                    ...
                                                    if pd.notna(orig_t_str) and str(orig_t_str).strip().lower() != 'nan':
                                                        ...
                                                        if t_obj:
                                                            ...
                                                            if is_d:
                                                                ...
                                                                if fixed_t_str: end_t = fixed_t_str
                                                    shift_times.append(f"{start_t}{selected_conn}{end_t} 午晚班一起")
                                                elif has_a:
                                                    start_t = "14:00" if is_licheng else "15:00"
                                                    ...
                                                    if pd.notna(orig_t_str) and str(orig_t_str).strip().lower() != 'nan':
                                                        ...
                                                        if t_obj:
                                                            ...
                                                            if is_d:
                                                                ...
                                                                if fixed_t_str: end_t = fixed_t_str
                                                    shift_times.append(f"{start_t}{selected_conn}{end_t} 午班")
                                                elif has_e:
                                                    ...
                                                    if pd.notna(orig_t_str) and str(orig_t_str).strip().lower() != 'nan':
                                                        ...
                                                        if t_obj:
                                                            ...
                                                            if is_d:
                                                                ...
                                                                fixed_t_str = calculate_time_rule(orig_t_str, "晚", selected_clinic, False, col)
                                                                if fixed_t_str: end_t = fixed_t_str
                                                    shift_times.append(f"{start_t}{selected_conn}{end_t} 晚班")
...
with tab2:
    ...
    if upl:
        ...
        try:
            ...
            idx_s = idx_s_cands[0] if idx_s_cands else (1 if len(cols)>1 else 0)
